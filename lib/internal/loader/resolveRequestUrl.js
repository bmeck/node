...
class CJSModuleRequest extends ModuleRequest {
  constructor(url) {
    ...
    this.reflect = internalCJSModule.getOrInsertNativeProxy(pathname);
    this.finish = this.reflect.finish;
  }
  async createModule() {
    return this.reflect.module;
  }
}

// Strategy for loading a node builtin CommonJS module that isn't
// through normal resolution
class NativeModuleRequest extends ModuleRequest {
  async createModule() {
