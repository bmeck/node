...
E('ERR_MANIFEST_ASSERT_DEPENDENCY',
  'Manifest resource %s has an invalid integrity: %s',
  SyntaxError);
...
E('ERR_MANIFEST_PARSE_INTEGRITY',
  'Manifest resource %s has an invalid integrity: %s',
  SyntaxError);
E('ERR_MANIFEST_PARSE_POLICY',
  'Manifest resource %s has an unknown policy: %s',
  SyntaxError);
E('ERR_MANIFEST_TDZ', 'Manifest initialization has not yet run', EvalError);
