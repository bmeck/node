...
messages = [...messages];
function init(exports, $require, module, process, $internalBinding) {
  ...
  /* eslint-disable node-core/alphabetize-errors */
  ...
  E('ERR_INVALID_PACKAGE_TARGET',
    (pkgPath, key, subpath, target, base = undefined) => {
      if (key === null) {
        ...
        } defined in the package config ${pkgPath}${sep}package.json`;
      } else {
        return `Invalid "exports" target ${
          JSONStringify(target)
        } defined for '${
          StringPrototypeSlice(key, 0, -subpath.length || key.length)
  ...
  /* eslint-enable node-core/alphabetize-errors */
